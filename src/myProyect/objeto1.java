 ...
 * @author halo_
 */
public class objeto1  extends GLCanvas implements GLEventListener,  KeyListener {
     private GLU glu;  // para las herramientas GL (GL Utilities)
     private GLUT glut;
     private static String TITLE = "Figura";  // window's title
...
//-----------------------------------------------------
  public void cuerpo( GL2 gl, GLUT glut ) 
    {
    glut.glutSolidCone(0.9, 1.8, 30, 30);
...
//-----------------------------------------------------
  ...
  glut.glutSolidCube(1);
    ...
    public void piernaIzquierda (GL2 gl,GLUT glut){
        ...
        gl.glTranslatef(-0.5f, 0, 1.7f);
        gl.glRotatef(rotacion, 1.0f, 0.f, 0.0f);
        glut.glutSolidCone(0.2, 0.9, 30, 30); 
    ...
    // glut.glutSolidSphere(0.9, 30, 30);
     ...
     public void piernaDerecha (GL2 gl,GLUT glut){
        ...
        this.setSomeGreenMaterial(gl, GL.GL_FRONT_AND_BACK);
        gl.glTranslatef(0.5f, 0, 1.7f);
        gl.glRotatef(rotacion2, 1.0f, 0.0f, 0.0f);
        glut.glutSolidCone(0.2, 0.9, 30, 30); 
        gl.glTranslatef(0f, 0, 0.9f);
        glut.glutSolidSphere(0.2, 30, 30);
